...
--
CREATE TYPE public."ConversationMessageType" AS ENUM ('character', 'narration', 'place');
...
--
CREATE TYPE public."FieldWidth" AS ENUM ('half', 'full');

--
-- Name: ImageType; Type: TYPE; Schema: public; Owner: -
--
CREATE TYPE public."ImageType" AS ENUM ('images', 'map_images');
...
--
CREATE FUNCTION public.updated_at_change() RETURNS trigger LANGUAGE plpgsql AS $ $ BEGIN NEW.updated_at = now();
...
--
CREATE TABLE public."_blueprint_instancesTotags" ("A" uuid NOT NULL, "B" uuid NOT NULL);

--
-- Name: _calendarsTotags; Type: TABLE; Schema: public; Owner: -
--
CREATE TABLE public."_calendarsTotags" ("A" uuid NOT NULL, "B" uuid NOT NULL);

--
-- Name: _calendarsTotimelines; Type: TABLE; Schema: public; Owner: -
--
CREATE TABLE public."_calendarsTotimelines" ("A" uuid NOT NULL, "B" uuid NOT NULL);

--
-- Name: _character_fields_templatesTotags; Type: TABLE; Schema: public; Owner: -
--
CREATE TABLE public."_character_fields_templatesTotags" ("A" uuid NOT NULL, "B" uuid NOT NULL);

--
-- Name: _charactersToconversations; Type: TABLE; Schema: public; Owner: -
--
CREATE TABLE public."_charactersToconversations" ("A" uuid NOT NULL, "B" uuid NOT NULL);

--
-- Name: _charactersTodocuments; Type: TABLE; Schema: public; Owner: -
--
CREATE TABLE public."_charactersTodocuments" ("A" uuid NOT NULL, "B" uuid NOT NULL);

--
-- Name: _charactersToimages; Type: TABLE; Schema: public; Owner: -
--
CREATE TABLE public."_charactersToimages" ("A" uuid NOT NULL, "B" uuid NOT NULL);

--
-- Name: _charactersTotags; Type: TABLE; Schema: public; Owner: -
--
CREATE TABLE public."_charactersTotags" ("A" uuid NOT NULL, "B" uuid NOT NULL);

--
-- Name: _dictionariesTotags; Type: TABLE; Schema: public; Owner: -
--
CREATE TABLE public."_dictionariesTotags" ("A" uuid NOT NULL, "B" uuid NOT NULL);

--
-- Name: _documentsTotags; Type: TABLE; Schema: public; Owner: -
--
CREATE TABLE public."_documentsTotags" ("A" uuid NOT NULL, "B" uuid NOT NULL);

--
-- Name: _edgesTotags; Type: TABLE; Schema: public; Owner: -
--
CREATE TABLE public."_edgesTotags" ("A" uuid NOT NULL, "B" uuid NOT NULL);

--
-- Name: _eventsTotags; Type: TABLE; Schema: public; Owner: -
--
CREATE TABLE public."_eventsTotags" ("A" uuid NOT NULL, "B" uuid NOT NULL);

--
-- Name: _graphsTotags; Type: TABLE; Schema: public; Owner: -
--
CREATE TABLE public."_graphsTotags" ("A" uuid NOT NULL, "B" uuid NOT NULL);

--
-- Name: _map_pinsTotags; Type: TABLE; Schema: public; Owner: -
--
CREATE TABLE public."_map_pinsTotags" ("A" uuid NOT NULL, "B" uuid NOT NULL);

--
-- Name: _mapsTotags; Type: TABLE; Schema: public; Owner: -
--
CREATE TABLE public."_mapsTotags" ("A" uuid NOT NULL, "B" uuid NOT NULL);

--
-- Name: _nodesTotags; Type: TABLE; Schema: public; Owner: -
--
CREATE TABLE public."_nodesTotags" ("A" uuid NOT NULL, "B" uuid NOT NULL);

--
-- Name: _project_members; Type: TABLE; Schema: public; Owner: -
--
CREATE TABLE public._project_members ("A" uuid NOT NULL, "B" uuid NOT NULL);
...
--
ALTER TABLE
    ONLY public.blueprint_instance_blueprint_instances
ADD
    CONSTRAINT blueprint_instance_blueprint_instances_pkey PRIMARY KEY (
...
--
ALTER TABLE
    ONLY public.blueprint_instance_calendars
ADD
    CONSTRAINT blueprint_instance_calendars_pkey PRIMARY KEY (
        blueprint_instance_id,
        blueprint_field_id,
        related_id
    );
...
--
ALTER TABLE
    ONLY public.blueprint_instance_characters
ADD
    CONSTRAINT blueprint_instance_characters_pkey PRIMARY KEY (
        blueprint_instance_id,
        blueprint_field_id,
        related_id
    );
...
--
ALTER TABLE
    ONLY public.blueprint_instance_documents
ADD
    CONSTRAINT blueprint_instance_documents_pkey PRIMARY KEY (
        blueprint_instance_id,
        blueprint_field_id,
        related_id
    );
...
--
ALTER TABLE
    ONLY public.blueprint_instance_images
ADD
    CONSTRAINT blueprint_instance_images_pkey PRIMARY KEY (
        blueprint_instance_id,
        blueprint_field_id,
        related_id
    );
...
--
ALTER TABLE
    ONLY public.blueprint_instance_map_pins
ADD
    CONSTRAINT blueprint_instance_map_pins_pkey PRIMARY KEY (
        blueprint_instance_id,
        blueprint_field_id,
        related_id
    );
...
--
ALTER TABLE
    ONLY public.blueprint_instance_random_tables
ADD
    CONSTRAINT blueprint_instance_random_tables_pkey PRIMARY KEY (
        blueprint_instance_id,
        blueprint_field_id,
        related_id
    );
...
--
ALTER TABLE
    ONLY public.blueprint_instance_value
ADD
...
--
ALTER TABLE
    ONLY public.blueprint_instances
ADD
...
--
ALTER TABLE
    ONLY public.character_blueprint_instance_fields
ADD
    CONSTRAINT character_blueprint_instance_fields_pkey PRIMARY KEY (character_id, character_field_id, related_id);

--
-- Name: character_calendar_fields character_calendar_fields_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public.character_calendar_fields
ADD
    CONSTRAINT character_calendar_fields_pkey PRIMARY KEY (character_id, character_field_id, related_id);

--
-- Name: character_documents_fields character_documents_fields_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public.character_documents_fields
ADD
    CONSTRAINT character_documents_fields_pkey PRIMARY KEY (character_id, character_field_id, related_id);
...
--
ALTER TABLE
    ONLY public.character_fields_templates
ADD
...
--
ALTER TABLE
    ONLY public.character_images_fields
ADD
    CONSTRAINT character_images_fields_pkey PRIMARY KEY (character_id, character_field_id, related_id);

--
-- Name: character_locations_fields character_locations_fields_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public.character_locations_fields
ADD
    CONSTRAINT character_locations_fields_pkey PRIMARY KEY (character_id, character_field_id, related_id);

--
-- Name: character_random_table_fields character_random_table_fields_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public.character_random_table_fields
ADD
    CONSTRAINT character_random_table_fields_pkey PRIMARY KEY (character_id, character_field_id, related_id);

--
-- Name: character_relationship_types character_relationship_types_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public.character_relationship_types
ADD
...
--
ALTER TABLE
    ONLY public.character_value_fields
ADD
    CONSTRAINT character_value_fields_pkey PRIMARY KEY (character_id, character_field_id);
...
--
ALTER TABLE
    ONLY public.characters_relationships
ADD
...
--
ALTER TABLE
    ONLY public.document_mentions
ADD
    CONSTRAINT document_mentions_pkey PRIMARY KEY (id);
...
--
ALTER TABLE
    ONLY public.leap_days
ADD
    CONSTRAINT leap_days_pkey PRIMARY KEY (id);

--
-- Name: map_layers map_layers_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public.map_layers
ADD
...
--
ALTER TABLE
    ONLY public.random_table_options
ADD
...
--
ALTER TABLE
    ONLY public.random_table_suboptions
ADD
...
--
CREATE UNIQUE INDEX blueprint_instance_calendars_blueprint_instance_id_blueprin_key ON public.blueprint_instance_calendars USING btree (
    blueprint_instance_id,
    blueprint_field_id,
    related_id
);
...
--
CREATE UNIQUE INDEX blueprint_instance_random_tables_blueprint_instance_id_blue_key ON public.blueprint_instance_random_tables USING btree (
    blueprint_instance_id,
    blueprint_field_id,
    related_id
);
...
UPDATE
    ON public.blueprint_instances FOR EACH ROW EXECUTE FUNCTION public.updated_at_change();
...
CREATE TRIGGER update_modified_time BEFORE
UPDATE
    ON public.blueprints FOR EACH ROW EXECUTE FUNCTION public.updated_at_change();
...
CREATE TRIGGER update_modified_time BEFORE
UPDATE
    ON public.calendars FOR EACH ROW EXECUTE FUNCTION public.updated_at_change();
...
CREATE TRIGGER update_modified_time BEFORE
UPDATE
    ON public.characters FOR EACH ROW EXECUTE FUNCTION public.updated_at_change();
...
CREATE TRIGGER update_modified_time BEFORE
UPDATE
    ON public.conversations FOR EACH ROW EXECUTE FUNCTION public.updated_at_change();
...
CREATE TRIGGER update_modified_time BEFORE
UPDATE
    ON public.dictionaries FOR EACH ROW EXECUTE FUNCTION public.updated_at_change();
...
CREATE TRIGGER update_modified_time BEFORE
UPDATE
    ON public.documents FOR EACH ROW EXECUTE FUNCTION public.updated_at_change();
...
CREATE TRIGGER update_modified_time BEFORE
UPDATE
    ON public.events FOR EACH ROW EXECUTE FUNCTION public.updated_at_change();
...
CREATE TRIGGER update_modified_time BEFORE
UPDATE
    ON public.graphs FOR EACH ROW EXECUTE FUNCTION public.updated_at_change();
...
CREATE TRIGGER update_modified_time BEFORE
UPDATE
    ON public.maps FOR EACH ROW EXECUTE FUNCTION public.updated_at_change();
...
CREATE TRIGGER update_modified_time BEFORE
UPDATE
    ON public.messages FOR EACH ROW EXECUTE FUNCTION public.updated_at_change();
...
CREATE TRIGGER update_modified_time BEFORE
UPDATE
    ON public.random_tables FOR EACH ROW EXECUTE FUNCTION public.updated_at_change();
...
CREATE TRIGGER update_modified_time BEFORE
UPDATE
    ON public.users FOR EACH ROW EXECUTE FUNCTION public.updated_at_change();

--
-- Name: _blueprint_instancesTotags _blueprint_instancesTotags_A_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public."_blueprint_instancesTotags"
ADD
    CONSTRAINT "_blueprint_instancesTotags_A_fkey" FOREIGN KEY ("A") REFERENCES public.blueprint_instances(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public."_blueprint_instancesTotags"
ADD
    CONSTRAINT "_blueprint_instancesTotags_B_fkey" FOREIGN KEY ("B") REFERENCES public.tags(id) ON UPDATE CASCADE ON DELETE CASCADE;

--
-- Name: _calendarsTotags _calendarsTotags_A_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public."_calendarsTotags"
ADD
    CONSTRAINT "_calendarsTotags_A_fkey" FOREIGN KEY ("A") REFERENCES public.calendars(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public."_calendarsTotags"
ADD
    CONSTRAINT "_calendarsTotags_B_fkey" FOREIGN KEY ("B") REFERENCES public.tags(id) ON UPDATE CASCADE ON DELETE CASCADE;

--
-- Name: _calendarsTotimelines _calendarsTotimelines_A_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public."_calendarsTotimelines"
ADD
    CONSTRAINT "_calendarsTotimelines_A_fkey" FOREIGN KEY ("A") REFERENCES public.calendars(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public."_calendarsTotimelines"
ADD
    CONSTRAINT "_calendarsTotimelines_B_fkey" FOREIGN KEY ("B") REFERENCES public.timelines(id) ON UPDATE CASCADE ON DELETE CASCADE;

--
-- Name: _character_fields_templatesTotags _character_fields_templatesTotags_A_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public."_character_fields_templatesTotags"
ADD
    CONSTRAINT "_character_fields_templatesTotags_A_fkey" FOREIGN KEY ("A") REFERENCES public.character_fields_templates(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public."_character_fields_templatesTotags"
ADD
    CONSTRAINT "_character_fields_templatesTotags_B_fkey" FOREIGN KEY ("B") REFERENCES public.tags(id) ON UPDATE CASCADE ON DELETE CASCADE;

--
-- Name: _charactersToconversations _charactersToconversations_A_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public."_charactersToconversations"
ADD
    CONSTRAINT "_charactersToconversations_A_fkey" FOREIGN KEY ("A") REFERENCES public.characters(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public."_charactersToconversations"
ADD
    CONSTRAINT "_charactersToconversations_B_fkey" FOREIGN KEY ("B") REFERENCES public.conversations(id) ON UPDATE CASCADE ON DELETE CASCADE;

--
-- Name: _charactersTodocuments _charactersTodocuments_A_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public."_charactersTodocuments"
ADD
    CONSTRAINT "_charactersTodocuments_A_fkey" FOREIGN KEY ("A") REFERENCES public.characters(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public."_charactersTodocuments"
ADD
    CONSTRAINT "_charactersTodocuments_B_fkey" FOREIGN KEY ("B") REFERENCES public.documents(id) ON UPDATE CASCADE ON DELETE CASCADE;

--
-- Name: _charactersToimages _charactersToimages_A_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public."_charactersToimages"
ADD
    CONSTRAINT "_charactersToimages_A_fkey" FOREIGN KEY ("A") REFERENCES public.characters(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public."_charactersToimages"
ADD
    CONSTRAINT "_charactersToimages_B_fkey" FOREIGN KEY ("B") REFERENCES public.images(id) ON UPDATE CASCADE ON DELETE CASCADE;

--
-- Name: _charactersTotags _charactersTotags_A_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public."_charactersTotags"
ADD
    CONSTRAINT "_charactersTotags_A_fkey" FOREIGN KEY ("A") REFERENCES public.characters(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public."_charactersTotags"
ADD
    CONSTRAINT "_charactersTotags_B_fkey" FOREIGN KEY ("B") REFERENCES public.tags(id) ON UPDATE CASCADE ON DELETE CASCADE;

--
-- Name: _dictionariesTotags _dictionariesTotags_A_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public."_dictionariesTotags"
ADD
    CONSTRAINT "_dictionariesTotags_A_fkey" FOREIGN KEY ("A") REFERENCES public.dictionaries(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public."_dictionariesTotags"
ADD
    CONSTRAINT "_dictionariesTotags_B_fkey" FOREIGN KEY ("B") REFERENCES public.tags(id) ON UPDATE CASCADE ON DELETE CASCADE;

--
-- Name: _documentsTotags _documentsTotags_A_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public."_documentsTotags"
ADD
    CONSTRAINT "_documentsTotags_A_fkey" FOREIGN KEY ("A") REFERENCES public.documents(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public."_documentsTotags"
ADD
    CONSTRAINT "_documentsTotags_B_fkey" FOREIGN KEY ("B") REFERENCES public.tags(id) ON UPDATE CASCADE ON DELETE CASCADE;

--
-- Name: _edgesTotags _edgesTotags_A_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public."_edgesTotags"
ADD
    CONSTRAINT "_edgesTotags_A_fkey" FOREIGN KEY ("A") REFERENCES public.edges(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public."_edgesTotags"
ADD
    CONSTRAINT "_edgesTotags_B_fkey" FOREIGN KEY ("B") REFERENCES public.tags(id) ON UPDATE CASCADE ON DELETE CASCADE;

--
-- Name: _eventsTotags _eventsTotags_A_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public."_eventsTotags"
ADD
    CONSTRAINT "_eventsTotags_A_fkey" FOREIGN KEY ("A") REFERENCES public.events(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public."_eventsTotags"
ADD
    CONSTRAINT "_eventsTotags_B_fkey" FOREIGN KEY ("B") REFERENCES public.tags(id) ON UPDATE CASCADE ON DELETE CASCADE;

--
-- Name: _graphsTotags _graphsTotags_A_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public."_graphsTotags"
ADD
    CONSTRAINT "_graphsTotags_A_fkey" FOREIGN KEY ("A") REFERENCES public.graphs(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public."_graphsTotags"
ADD
    CONSTRAINT "_graphsTotags_B_fkey" FOREIGN KEY ("B") REFERENCES public.tags(id) ON UPDATE CASCADE ON DELETE CASCADE;

--
-- Name: _map_pinsTotags _map_pinsTotags_A_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public."_map_pinsTotags"
ADD
    CONSTRAINT "_map_pinsTotags_A_fkey" FOREIGN KEY ("A") REFERENCES public.map_pins(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public."_map_pinsTotags"
ADD
    CONSTRAINT "_map_pinsTotags_B_fkey" FOREIGN KEY ("B") REFERENCES public.tags(id) ON UPDATE CASCADE ON DELETE CASCADE;

--
-- Name: _mapsTotags _mapsTotags_A_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public."_mapsTotags"
ADD
    CONSTRAINT "_mapsTotags_A_fkey" FOREIGN KEY ("A") REFERENCES public.maps(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public."_mapsTotags"
ADD
    CONSTRAINT "_mapsTotags_B_fkey" FOREIGN KEY ("B") REFERENCES public.tags(id) ON UPDATE CASCADE ON DELETE CASCADE;

--
-- Name: _nodesTotags _nodesTotags_A_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public."_nodesTotags"
ADD
    CONSTRAINT "_nodesTotags_A_fkey" FOREIGN KEY ("A") REFERENCES public.nodes(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public."_nodesTotags"
ADD
    CONSTRAINT "_nodesTotags_B_fkey" FOREIGN KEY ("B") REFERENCES public.tags(id) ON UPDATE CASCADE ON DELETE CASCADE;

--
-- Name: _project_members _project_members_A_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public._project_members
ADD
    CONSTRAINT "_project_members_A_fkey" FOREIGN KEY ("A") REFERENCES public.projects(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public._project_members
ADD
    CONSTRAINT "_project_members_B_fkey" FOREIGN KEY ("B") REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.alter_names
ADD
    CONSTRAINT alter_names_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.documents(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.alter_names
ADD
    CONSTRAINT alter_names_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprint_fields
ADD
    CONSTRAINT blueprint_fields_blueprint_id_fkey FOREIGN KEY (blueprint_id) REFERENCES public.blueprints(id) ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
ALTER TABLE
    ONLY public.blueprint_fields
ADD
    CONSTRAINT blueprint_fields_calendar_id_fkey FOREIGN KEY (calendar_id) REFERENCES public.calendars(id) ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
ALTER TABLE
    ONLY public.blueprint_fields
ADD
    CONSTRAINT blueprint_fields_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.blueprints(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprint_fields
ADD
    CONSTRAINT blueprint_fields_random_table_id_fkey FOREIGN KEY (random_table_id) REFERENCES public.random_tables(id) ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
ALTER TABLE
    ONLY public.blueprint_instance_blueprint_instances
ADD
    CONSTRAINT blueprint_instance_blueprint_instances_blueprint_field_id_fkey FOREIGN KEY (blueprint_field_id) REFERENCES public.blueprint_fields(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprint_instance_blueprint_instances
ADD
    CONSTRAINT blueprint_instance_blueprint_instances_blueprint_instance__fkey FOREIGN KEY (blueprint_instance_id) REFERENCES public.blueprint_instances(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprint_instance_blueprint_instances
ADD
    CONSTRAINT blueprint_instance_blueprint_instances_related_id_fkey FOREIGN KEY (related_id) REFERENCES public.blueprint_instances(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprint_instance_calendars
ADD
    CONSTRAINT blueprint_instance_calendars_blueprint_field_id_fkey FOREIGN KEY (blueprint_field_id) REFERENCES public.blueprint_fields(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprint_instance_calendars
ADD
    CONSTRAINT blueprint_instance_calendars_blueprint_instance_id_fkey FOREIGN KEY (blueprint_instance_id) REFERENCES public.blueprint_instances(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprint_instance_calendars
ADD
    CONSTRAINT blueprint_instance_calendars_end_month_id_fkey FOREIGN KEY (end_month_id) REFERENCES public.months(id) ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
ALTER TABLE
    ONLY public.blueprint_instance_calendars
ADD
    CONSTRAINT blueprint_instance_calendars_related_id_fkey FOREIGN KEY (related_id) REFERENCES public.calendars(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprint_instance_calendars
ADD
    CONSTRAINT blueprint_instance_calendars_start_month_id_fkey FOREIGN KEY (start_month_id) REFERENCES public.months(id) ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
ALTER TABLE
    ONLY public.blueprint_instance_characters
ADD
    CONSTRAINT blueprint_instance_characters_blueprint_field_id_fkey FOREIGN KEY (blueprint_field_id) REFERENCES public.blueprint_fields(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprint_instance_characters
ADD
    CONSTRAINT blueprint_instance_characters_blueprint_instance_id_fkey FOREIGN KEY (blueprint_instance_id) REFERENCES public.blueprint_instances(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprint_instance_characters
ADD
    CONSTRAINT blueprint_instance_characters_related_id_fkey FOREIGN KEY (related_id) REFERENCES public.characters(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprint_instance_documents
ADD
    CONSTRAINT blueprint_instance_documents_blueprint_field_id_fkey FOREIGN KEY (blueprint_field_id) REFERENCES public.blueprint_fields(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprint_instance_documents
ADD
    CONSTRAINT blueprint_instance_documents_blueprint_instance_id_fkey FOREIGN KEY (blueprint_instance_id) REFERENCES public.blueprint_instances(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprint_instance_documents
ADD
    CONSTRAINT blueprint_instance_documents_related_id_fkey FOREIGN KEY (related_id) REFERENCES public.documents(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprint_instance_images
ADD
    CONSTRAINT blueprint_instance_images_blueprint_field_id_fkey FOREIGN KEY (blueprint_field_id) REFERENCES public.blueprint_fields(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprint_instance_images
ADD
    CONSTRAINT blueprint_instance_images_blueprint_instance_id_fkey FOREIGN KEY (blueprint_instance_id) REFERENCES public.blueprint_instances(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprint_instance_images
ADD
    CONSTRAINT blueprint_instance_images_related_id_fkey FOREIGN KEY (related_id) REFERENCES public.images(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprint_instance_map_pins
ADD
    CONSTRAINT blueprint_instance_map_pins_blueprint_field_id_fkey FOREIGN KEY (blueprint_field_id) REFERENCES public.blueprint_fields(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprint_instance_map_pins
ADD
    CONSTRAINT blueprint_instance_map_pins_blueprint_instance_id_fkey FOREIGN KEY (blueprint_instance_id) REFERENCES public.blueprint_instances(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprint_instance_map_pins
ADD
    CONSTRAINT blueprint_instance_map_pins_related_id_fkey FOREIGN KEY (related_id) REFERENCES public.map_pins(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprint_instance_random_tables
ADD
    CONSTRAINT blueprint_instance_random_tables_blueprint_field_id_fkey FOREIGN KEY (blueprint_field_id) REFERENCES public.blueprint_fields(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprint_instance_random_tables
ADD
    CONSTRAINT blueprint_instance_random_tables_blueprint_instance_id_fkey FOREIGN KEY (blueprint_instance_id) REFERENCES public.blueprint_instances(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprint_instance_random_tables
ADD
    CONSTRAINT blueprint_instance_random_tables_option_id_fkey FOREIGN KEY (option_id) REFERENCES public.random_table_options(id) ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
ALTER TABLE
    ONLY public.blueprint_instance_random_tables
ADD
    CONSTRAINT blueprint_instance_random_tables_related_id_fkey FOREIGN KEY (related_id) REFERENCES public.random_tables(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprint_instance_random_tables
ADD
    CONSTRAINT blueprint_instance_random_tables_suboption_id_fkey FOREIGN KEY (suboption_id) REFERENCES public.random_table_suboptions(id) ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
ALTER TABLE
    ONLY public.blueprint_instance_value
ADD
    CONSTRAINT blueprint_instance_value_blueprint_field_id_fkey FOREIGN KEY (blueprint_field_id) REFERENCES public.blueprint_fields(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprint_instance_value
ADD
    CONSTRAINT blueprint_instance_value_blueprint_instance_id_fkey FOREIGN KEY (blueprint_instance_id) REFERENCES public.blueprint_instances(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprint_instances
ADD
    CONSTRAINT blueprint_instances_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.blueprints(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.blueprints
ADD
    CONSTRAINT blueprints_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.calendars
ADD
    CONSTRAINT calendars_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.calendars(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.calendars
ADD
    CONSTRAINT calendars_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.character_blueprint_instance_fields
ADD
    CONSTRAINT character_blueprint_instance_fields_character_field_id_fkey FOREIGN KEY (character_field_id) REFERENCES public.character_fields(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.character_blueprint_instance_fields
ADD
    CONSTRAINT character_blueprint_instance_fields_character_id_fkey FOREIGN KEY (character_id) REFERENCES public.characters(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.character_blueprint_instance_fields
ADD
    CONSTRAINT character_blueprint_instance_fields_related_id_fkey FOREIGN KEY (related_id) REFERENCES public.blueprint_instances(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.character_calendar_fields
ADD
    CONSTRAINT character_calendar_fields_character_field_id_fkey FOREIGN KEY (character_field_id) REFERENCES public.character_fields(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.character_calendar_fields
ADD
    CONSTRAINT character_calendar_fields_character_id_fkey FOREIGN KEY (character_id) REFERENCES public.characters(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.character_calendar_fields
ADD
    CONSTRAINT character_calendar_fields_end_month_id_fkey FOREIGN KEY (end_month_id) REFERENCES public.months(id) ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
ALTER TABLE
    ONLY public.character_calendar_fields
ADD
    CONSTRAINT character_calendar_fields_related_id_fkey FOREIGN KEY (related_id) REFERENCES public.calendars(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.character_calendar_fields
ADD
    CONSTRAINT character_calendar_fields_start_month_id_fkey FOREIGN KEY (start_month_id) REFERENCES public.months(id) ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
ALTER TABLE
    ONLY public.character_documents_fields
ADD
    CONSTRAINT character_documents_fields_character_field_id_fkey FOREIGN KEY (character_field_id) REFERENCES public.character_fields(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.character_documents_fields
ADD
    CONSTRAINT character_documents_fields_character_id_fkey FOREIGN KEY (character_id) REFERENCES public.characters(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.character_documents_fields
ADD
    CONSTRAINT character_documents_fields_related_id_fkey FOREIGN KEY (related_id) REFERENCES public.documents(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.character_fields
ADD
    CONSTRAINT character_fields_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.character_fields_templates(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.character_fields_templates
ADD
    CONSTRAINT character_fields_templates_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.character_images_fields
ADD
    CONSTRAINT character_images_fields_character_field_id_fkey FOREIGN KEY (character_field_id) REFERENCES public.character_fields(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.character_images_fields
ADD
    CONSTRAINT character_images_fields_character_id_fkey FOREIGN KEY (character_id) REFERENCES public.characters(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.character_images_fields
ADD
    CONSTRAINT character_images_fields_related_id_fkey FOREIGN KEY (related_id) REFERENCES public.images(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.character_locations_fields
ADD
    CONSTRAINT character_locations_fields_character_field_id_fkey FOREIGN KEY (character_field_id) REFERENCES public.character_fields(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.character_locations_fields
ADD
    CONSTRAINT character_locations_fields_character_id_fkey FOREIGN KEY (character_id) REFERENCES public.characters(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.character_locations_fields
ADD
    CONSTRAINT character_locations_fields_related_id_fkey FOREIGN KEY (related_id) REFERENCES public.map_pins(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.character_random_table_fields
ADD
    CONSTRAINT character_random_table_fields_character_field_id_fkey FOREIGN KEY (character_field_id) REFERENCES public.character_fields(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.character_random_table_fields
ADD
    CONSTRAINT character_random_table_fields_character_id_fkey FOREIGN KEY (character_id) REFERENCES public.characters(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.character_random_table_fields
ADD
    CONSTRAINT character_random_table_fields_option_id_fkey FOREIGN KEY (option_id) REFERENCES public.random_table_options(id) ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
ALTER TABLE
    ONLY public.character_random_table_fields
ADD
    CONSTRAINT character_random_table_fields_related_id_fkey FOREIGN KEY (related_id) REFERENCES public.random_tables(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.character_random_table_fields
ADD
    CONSTRAINT character_random_table_fields_suboption_id_fkey FOREIGN KEY (suboption_id) REFERENCES public.random_table_suboptions(id) ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
ALTER TABLE
    ONLY public.character_relationship_types
ADD
    CONSTRAINT character_relationship_types_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.character_value_fields
ADD
    CONSTRAINT character_value_fields_character_field_id_fkey FOREIGN KEY (character_field_id) REFERENCES public.character_fields(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.character_value_fields
ADD
    CONSTRAINT character_value_fields_character_id_fkey FOREIGN KEY (character_id) REFERENCES public.characters(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.characters
ADD
    CONSTRAINT characters_portrait_id_fkey FOREIGN KEY (portrait_id) REFERENCES public.images(id) ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
ALTER TABLE
    ONLY public.characters
ADD
    CONSTRAINT characters_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.characters_relationships
ADD
    CONSTRAINT characters_relationships_character_a_id_fkey FOREIGN KEY (character_a_id) REFERENCES public.characters(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.characters_relationships
ADD
    CONSTRAINT characters_relationships_character_b_id_fkey FOREIGN KEY (character_b_id) REFERENCES public.characters(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.characters_relationships
ADD
    CONSTRAINT characters_relationships_relation_type_id_fkey FOREIGN KEY (relation_type_id) REFERENCES public.character_relationship_types(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.conversations
ADD
    CONSTRAINT conversations_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.dictionaries
ADD
    CONSTRAINT dictionaries_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.dictionaries(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.dictionaries
ADD
    CONSTRAINT dictionaries_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.documents
ADD
    CONSTRAINT documents_image_id_fkey FOREIGN KEY (image_id) REFERENCES public.images(id) ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
ALTER TABLE
    ONLY public.documents
ADD
    CONSTRAINT documents_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.documents(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.documents
ADD
    CONSTRAINT documents_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.edges
ADD
    CONSTRAINT edges_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.graphs(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.edges
ADD
    CONSTRAINT edges_source_id_fkey FOREIGN KEY (source_id) REFERENCES public.nodes(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.edges
ADD
    CONSTRAINT edges_target_id_fkey FOREIGN KEY (target_id) REFERENCES public.nodes(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.events
ADD
    CONSTRAINT events_document_id_fkey FOREIGN KEY (document_id) REFERENCES public.documents(id) ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
ALTER TABLE
    ONLY public.events
ADD
    CONSTRAINT events_image_id_fkey FOREIGN KEY (image_id) REFERENCES public.images(id) ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
ALTER TABLE
    ONLY public.events
ADD
    CONSTRAINT events_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.calendars(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.graphs
ADD
    CONSTRAINT graphs_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.graphs(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.graphs
ADD
    CONSTRAINT graphs_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.images
ADD
    CONSTRAINT images_project_image_id_fkey FOREIGN KEY (project_image_id) REFERENCES public.projects(id) ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
ALTER TABLE
    ONLY public.leap_days
ADD
    CONSTRAINT leap_days_month_id_fkey FOREIGN KEY (month_id) REFERENCES public.months(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.leap_days
ADD
    CONSTRAINT leap_days_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.calendars(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.map_layers
ADD
    CONSTRAINT map_layers_image_id_fkey FOREIGN KEY (image_id) REFERENCES public.images(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.map_layers
ADD
    CONSTRAINT map_layers_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.maps(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.map_pins
ADD
    CONSTRAINT map_pins_image_id_fkey FOREIGN KEY (image_id) REFERENCES public.images(id) ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
ALTER TABLE
    ONLY public.map_pins
ADD
    CONSTRAINT map_pins_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.maps(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.maps
ADD
    CONSTRAINT maps_image_id_fkey FOREIGN KEY (image_id) REFERENCES public.images(id) ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
ALTER TABLE
    ONLY public.maps
ADD
    CONSTRAINT maps_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.maps(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.maps
ADD
    CONSTRAINT maps_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.messages
ADD
    CONSTRAINT messages_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.conversations(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.messages
ADD
    CONSTRAINT messages_sender_id_fkey FOREIGN KEY (sender_id) REFERENCES public.characters(id) ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
ALTER TABLE
    ONLY public.months
ADD
    CONSTRAINT months_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.calendars(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.nodes
ADD
    CONSTRAINT nodes_character_id_fkey FOREIGN KEY (character_id) REFERENCES public.characters(id) ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
ALTER TABLE
    ONLY public.nodes
ADD
    CONSTRAINT nodes_doc_id_fkey FOREIGN KEY (doc_id) REFERENCES public.documents(id) ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
ALTER TABLE
    ONLY public.nodes
ADD
    CONSTRAINT nodes_event_id_fkey FOREIGN KEY (event_id) REFERENCES public.events(id) ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
ALTER TABLE
    ONLY public.nodes
ADD
    CONSTRAINT nodes_image_id_fkey FOREIGN KEY (image_id) REFERENCES public.images(id) ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
ALTER TABLE
    ONLY public.nodes
ADD
    CONSTRAINT nodes_map_id_fkey FOREIGN KEY (map_id) REFERENCES public.maps(id) ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
ALTER TABLE
    ONLY public.nodes
ADD
    CONSTRAINT nodes_map_pin_id_fkey FOREIGN KEY (map_pin_id) REFERENCES public.map_pins(id) ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
ALTER TABLE
    ONLY public.nodes
ADD
    CONSTRAINT nodes_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.graphs(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.projects
ADD
    CONSTRAINT projects_owner_id_fkey FOREIGN KEY (owner_id) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.random_table_options
ADD
    CONSTRAINT random_table_options_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.random_tables(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.random_table_suboptions
ADD
    CONSTRAINT random_table_suboptions_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.random_table_options(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.random_tables
ADD
    CONSTRAINT random_tables_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.random_tables(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.random_tables
ADD
    CONSTRAINT random_tables_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.tags
ADD
    CONSTRAINT tags_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.timelines
ADD
    CONSTRAINT timelines_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.timelines(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.timelines
ADD
    CONSTRAINT timelines_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.webhooks
ADD
    CONSTRAINT webhooks_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.words
ADD
    CONSTRAINT words_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.dictionaries(id) ON UPDATE CASCADE ON DELETE CASCADE;
